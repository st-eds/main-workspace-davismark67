...
public class Program {
    public static void main(String[] args) {
        ...
        // Prologue -------------------
        System.out.println("Your car crahses into a tree during a thunderstorm in the woods.");
        System.out.println("Darkness surrounds yo asa thunder crashes and rain pours.");
        System.out.println("You spot a cave nearby, dimly lit by flashes of lightning. and run toward its for shelter.");
        ...
        if (path.equals("left") || path.equals("right")) {
            ...
            if (twinkieChoice.equals("take")) {
                ...
                System.out.println("Feeling uneasy, you eat the Twinkie to keep up your stength.\n");
            }
            else {
                System.out.print("You leave the Twinkie untouched, feeling an ominous presence watching.\n");
            }
        }
        ...
        // Else -> No path chosen
        if (path.equals("left")) {
            System.out.println("You cautiously take the lft path.");
            ...
            System.out.println("Suddenly, a rotten, smoky smell fills the air. A massive dragon");
        }
        else {
